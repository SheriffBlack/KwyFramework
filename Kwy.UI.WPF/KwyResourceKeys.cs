...
/// <summary>
/// Public resource keys used by Kwy WPF controls and helpers.
/// </summary>
public static class KwyResourceKeys
{
    ...
    public const string ToggleButtonSwitchNoContentStyle = "ToggleButtonSwitchNoContentStyle";
}
