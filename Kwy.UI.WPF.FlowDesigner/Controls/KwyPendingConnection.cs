...
/// 预连线控件，用于拖拽时的虚线预览。
/// </summary>
public class KwyPendingConnection : Control
{
    static KwyPendingConnection()
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(KwyPendingConnection), new FrameworkPropertyMetadata(typeof(KwyPendingConnection)));
    }
    ...
    public static readonly DependencyProperty ArrowSizeProperty =
        DependencyProperty.Register("ArrowSize", typeof(double), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty ArrowWidthProperty =
        DependencyProperty.Register("ArrowWidth", typeof(double), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty HubOffsetProperty =
        DependencyProperty.Register("HubOffset", typeof(double), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty CornerRadiusProperty =
        DependencyProperty.Register("CornerRadius", typeof(double), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty OrthogonalMarginProperty =
        DependencyProperty.Register("OrthogonalMargin", typeof(double), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty BezierDistanceProperty =
        DependencyProperty.Register("BezierDistance", typeof(double), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty AdjustedTargetProperty =
        DependencyProperty.Register("AdjustedTarget", typeof(Point), typeof(KwyPendingConnection),
    ...
    {
        if (d is KwyPendingConnection conn)
        {
    ...
    {
        // Source和Target相同时（连线未开始），不生成路径，防止渲染出蓝色虚线残影矩形
    ...
    public static readonly DependencyProperty PathDataProperty =
        DependencyProperty.Register("PathData", typeof(Geometry), typeof(KwyPendingConnection), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register("Source", typeof(Point), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty TargetProperty =
        DependencyProperty.Register("Target", typeof(Point), typeof(KwyPendingConnection),
            new FrameworkPropertyMetadata(default(Point), FrameworkPropertyMetadataOptions.AffectsRender, OnPointsChanged));
    ...
    public static readonly DependencyProperty StrokeProperty =
        DependencyProperty.Register("Stroke", typeof(Brush), typeof(KwyPendingConnection), new PropertyMetadata(Brushes.Purple));
    ...
    public static readonly DependencyProperty StrokeThicknessProperty =
        DependencyProperty.Register("StrokeThickness", typeof(double), typeof(KwyPendingConnection), new PropertyMetadata(2.0));
    ...
    public static readonly DependencyProperty ConnectionStyleProperty =
        DependencyProperty.Register("ConnectionStyle", typeof(ConnectionStyle), typeof(KwyPendingConnection),
    ...
    public static readonly DependencyProperty DirectionProperty =
        DependencyProperty.Register("Direction", typeof(Orientation), typeof(KwyPendingConnection),
